...
import com.suixingpay.service.IMailService;
...
/**
 * @description:
 * @author: liushuai<liu_shuai @ suixingpay.com>
...
public class IMailServiceImpl implements IMailService {
     ...
     */
    @Override
    public String sendAttachmentsMail(String from,String to, String subject, String content, String filePath) {
        MimeMessage message = mailSender.createMimeMessage();
        try {
